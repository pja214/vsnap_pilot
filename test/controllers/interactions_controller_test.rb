...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { comments: @interaction.comments, complete: @interaction.complete, employee_id: @interaction.employee_id, response: @interaction.response, task: @interaction.task, url: @interaction.url }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { comments: @interaction.comments, complete: @interaction.complete, employee_id: @interaction.employee_id, response: @interaction.response, task: @interaction.task, url: @interaction.url }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
